...
_text = "<br />NOTE: L'équipement qui suit n'est exact qu'au départ de la mission.<br />
<br />";
_stuff = [];
...
if (count _weps > 0) then {
	_text = _text + "<font size='18'>ARMES [#CHARGEURS]:</font>";
	{
...
if (count _mags > 0) then {
	_text = _text + "<br/><font size='18'>AUTRES [#]:</font><br/>";
...
if !(backpack player == "") then {
	_text = _text + "<br/><font size='18'>SAC A DOS [%FULL]:</font><br/>";
...
if (count _items > 0) then {
	_text = _text + "<br/><font size='18'>MATERIEL [#]:</font><br/>";
...
player createDiaryRecord ["diary", ["EQUIPEMENT", _text]];