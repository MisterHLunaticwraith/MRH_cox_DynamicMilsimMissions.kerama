...
_orbatText = "<br />NOTE: L'organisation structurelle n'est exacte qu'au démarrage de la mission.<br />
<br />
...
player createDiaryRecord ["diary", ["Organisation Structurelle", _orbatText]];